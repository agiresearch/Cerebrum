...
def setup_client(
    ...
    try:
        client.add_llm_layer(
            ...
            OverridesLayer(max_workers=max_workers)
        )
...
def run_agent(
    client: Cerebrum, agent_path: str, task: str, timeout: int = 300
...
def main():
    ...
    try:
        ...
        result = run_agent(
            client=client, agent_path=args.agent, task=args.task, timeout=args.timeout
        )
